let data =[
    ...
    {
      "id": 8,
      "title": "Rose Gold Plated Stainless Double",
      "price": 10.99,
    ...
    {
      "id": 11,
      "title": "256GB SSD 3D NAND A55 SLC  Performance Boost SATA III 2.5",
      "price": 109,
    ...
    {
      "id": 12,
      "title": "WD 4TB Gaming Drive Works with Playstation 4 Hard Drive",
      "price": 114,
    ...
    {
      "id": 14,
      "title": "Samsung 49-Inch CHG90 144Hz Curved Gaming Screen QLED ",
      "price": 999.99,
...
document.getElementById('p').addEventListener("click",all)
    ...
    data.map((ele) => {
        ...
        <div class="card-body">
           ...
           <div class="col-8"> 
                ...
                <span class="badge fs-6 fw-semibold text-danger">${ele.rating.count < 200 ? `limited stock` : ``}</span> 
           </div>
            <div class="col-4">       
                <span class="fw-semibold">⭐ ${ele.rating.rate}</span>
            </div>
                    </div>
                    <hr>    
